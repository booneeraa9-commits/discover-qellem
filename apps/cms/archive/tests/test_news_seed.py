...
# slug -> (category, published_date) - categories follow the
# PM-approved 9-key taxonomy matching the frontend categoryKey.
EXPECTED_ARTICLES = {
    "coffee-2026": ("economy", date(2026, 8, 8)),
    "walal-2026": ("environment", date(2026, 7, 14)),
    "gold-2026": ("minerals", date(2026, 6, 3)),
    "honey-2026": ("agriculture", date(2026, 5, 19)),
...
class NewsSeedStructureTests(TestCase):
    ...
    def test_verified_figures_are_present(self):
        checks = {
            ...
            "honey-2026": ("473,300", "339,193"),
            "health-2026": ("4 hospitals", "51", "256", "372", "43,960"),
            "schools-2026": ("452", "50", "348,516", "teachers' college"),
        }
