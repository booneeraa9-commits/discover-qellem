...
export const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "contribute.sub": "Send a story or correction — no account needed.",
    ...
    "contribute.woreda": "Woreda / Town",
    "contribute.rights": "I confirm I have the right to share this story",
    "contribute.required": "This field is required",
    "contribute.tooShort": "Please write at least 20 characters",
    "contribute.success.title": "Your story has been submitted for review",
    "contribute.success.sub": "Thank you — our editors will review it before publishing.",
    "contribute.rateLimit": "Please wait before submitting another story",
    "contribute.mock": "Submissions are disabled in preview mode",
    "contribute.failed": "Something went wrong. Please try again.",
    ...
    "staff.loginError": "Sign-in failed. Check your credentials and try again.",
    "staff.unavailable": "Sign-in is not available yet.",
    "staff.welcome": "Welcome",
    "staff.admin": "Open CMS admin",
    "staff.profile": "Open your profile",
    "staff.loggedOut": "Signed out.",
  ...
  om: {
    ...
    "contribute.sub": "Seenaa ykn sirreessa ergi — galmeen hin barbaachisu.",
    ...
    "contribute.optional": "Filatamaa",
    "contribute.woreda": "Aanaa / Magaalaa",
    "contribute.rights": "Mirga seenaa kana qooduuf qabaachuu koo nan mirkaneessa",
    "contribute.required": "Dirqiidha",
    "contribute.tooShort": "Maaloo qubee 20 yoo xiqqaate barreessi",
    "contribute.success.title": "Seenaan kee ilaalchaaf dhiyaateera",
    "contribute.success.sub": "Galatoomi — gulaaltoonni maxxansuu dura ilaalu.",
    "contribute.rateLimit": "Seenaa biraa erguuf yeroo xiqqoo eegi",
    "contribute.mock": "[OM] Submissions are disabled in preview mode",
    "contribute.failed": "[OM] Something went wrong. Please try again.",

    "staff.kicker": "Hojjettoota",
    // TODO(i18n): get reviewed OM for these staff-page strings from the content agent.
    "staff.title": "[OM] Editorial sign-in",
    "staff.sub": "Editori fi bulchiinsaaf qofa.",
    "staff.cta": "[OM] Open Wagtail admin",
    "staff.username": "[OM] Username",
    "staff.password": "[OM] Password",
    "staff.signIn": "Seensaa",
    "staff.signingIn": "[OM] Signing in",
    "staff.logout": "[OM] Sign out",
    "staff.loginError": "[OM] Sign-in failed. Check your credentials and try again.",
    "staff.unavailable": "[OM] Sign-in is not available yet.",
    "staff.welcome": "Baga nagaan dhufte",
    "staff.admin": "[OM] Open CMS admin",
    "staff.profile": "[OM] Open your profile",
    "staff.loggedOut": "[OM] Signed out.",
  ...
  am: {
    ...
    "contribute.optional": "[AM draft]",
    "contribute.woreda": "[AM draft]",
    "contribute.rights": "[AM draft]",
    "contribute.required": "[AM draft]",
    "contribute.tooShort": "[AM draft]",
    "contribute.success.title": "[AM draft]",
    "contribute.success.sub": "[AM draft]",
    "contribute.rateLimit": "[AM draft]",
    "contribute.mock": "[AM draft]",
    "contribute.failed": "[AM draft]",
    "staff.kicker": "[AM draft]",
    "staff.title": "[AM draft]",
    "staff.sub": "[AM draft]",
    "staff.cta": "[AM draft]",
    "staff.username": "[AM draft]",
    "staff.password": "[AM draft]",
    "staff.signIn": "[AM draft]",
    "staff.signingIn": "[AM draft]",
    "staff.logout": "[AM draft]",
    "staff.loginError": "[AM draft]",
    "staff.unavailable": "[AM draft]",
    "staff.welcome": "[AM draft]",
    "staff.admin": "[AM draft]",
    "staff.profile": "[AM draft]",
    "staff.loggedOut": "[AM draft]",
